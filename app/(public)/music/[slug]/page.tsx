  ...
  return (
    <main className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1280px] space-y-8">
        ...
        <section className="rounded-[36px] border border-white/10 bg-[#0f1217]/92 px-6 py-8 sm:px-8 sm:py-10">
          <div className="grid gap-8 lg:grid-cols-[0.92fr_1.08fr] lg:items-start">
            ...
            <div>
              ...
              <h1 className="mt-5 text-4xl font-semibold tracking-[-0.04em] text-[#f7f1e6] sm:text-5xl">
                {release.title}
              </h1>
