  ...
  return (
    <main className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1280px] space-y-8">
        <section className="rounded-[34px] border border-white/10 bg-[#0f1217]/92 px-6 py-10 sm:px-8">
          <p className="text-[11px] font-semibold uppercase tracking-[0.28em] text-[#8d949d]">
            {content.page_eyebrow}
          </p>
          <h1 className="mt-4 text-4xl font-semibold tracking-[-0.04em] text-[#f7f1e6] sm:text-5xl">
        ...
        {releases.length > 0 ? (
          ...
          <section className="rounded-[30px] border border-dashed border-white/12 bg-[#0f1217]/92 px-6 py-10 text-sm leading-7 text-[#98a0a8]">
