  ...
  return (
    <main className="px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-[1280px] space-y-8">
        <section className="relative overflow-hidden rounded-[36px] border border-white/10 bg-[#0f1217]/92 px-6 py-8 sm:px-8 sm:py-10">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_360px] lg:items-stretch">
            <div className="flex h-full items-center justify-center rounded-[30px] border border-white/10 bg-[#11151a]/80 p-6 sm:p-8">
        ...
        <section className="rounded-[34px] border border-white/10 bg-[#0f1217]/92 px-6 py-8 sm:px-8">
              ...
              {siteSettings.social_links.map((socialLink) => {
                ...
                return (
                  <Link
                    ...
                    className={`group relative inline-flex h-[72px] w-[72px] items-center justify-center overflow-hidden rounded-[24px] border text-center text-[#f4eedf] shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition duration-300 hover:scale-[1.05] ${accent.buttonClassName}`}
                    ...
                    {socialLogoFile ? (
                      <span className="relative flex h-11 w-11 items-center justify-center">
                        <Image
                          ...
                          className={`max-h-9 w-auto object-contain opacity-90 transition duration-300 group-hover:opacity-100 ${accent.imageClassName}`.trim()}
                          height={36}
